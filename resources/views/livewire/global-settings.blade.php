    ...
    <div class="mx-auto max-w-7xl px-4 py-8 space-y-6">
        ...
        <section class="rounded-lg border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900">
            ...
            <div class="mb-5 grid gap-3 md:grid-cols-3">
                <select wire:model.live="archiveFilterSemester" class="rounded-md border border-slate-300 bg-white px-3 py-3 text-xs font-bold uppercase outline-none transition focus:border-indigo-500 focus:ring-2 focus:ring-indigo-100 dark:border-slate-700 dark:bg-slate-950">
                    <option value="">All Semesters</option>
                    <option value="1st">1st Semester</option>
                    <option value="2nd">2nd Semester</option>
                    <option value="Summer">Summer</option>
                </select>
                <input type="text" wire:model.live="archiveFilterSchoolYear" placeholder="School year" class="rounded-md border border-slate-300 bg-white px-3 py-3 text-xs font-bold uppercase outline-none transition focus:border-indigo-500 focus:ring-2 focus:ring-indigo-100 dark:border-slate-700 dark:bg-slate-950">
                <select wire:model.live="archiveFilterDepartment" class="rounded-md border border-slate-300 bg-white px-3 py-3 text-xs font-bold uppercase outline-none transition focus:border-indigo-500 focus:ring-2 focus:ring-indigo-100 dark:border-slate-700 dark:bg-slate-950">
