        ...
        <header class="flex items-center justify-between">
            <div class="transition-transform duration-500 hover:translate-x-1">
                <h2 class="text-3xl font-black uppercase tracking-tighter" :class="darkMode ? 'text-white' : 'text-slate-900'">
                    Admin <span class="text-blue-500">Command Center</span>
                </h2>
                <p class="text-[10px] font-bold uppercase tracking-[0.4em] opacity-40">Global Root v3.0 | Professional Academy of the Philippines</p>
            </div>
        ...
        <div class="flex-1 grid grid-cols-12 grid-rows-6 gap-6 min-h-0 pb-4">
            ...
            <div class="col-span-6 row-span-2 rounded-[2.5rem] border p-8 transition-all duration-500 relative overflow-hidden group hover:scale-[1.01] shadow-2xl"
                ...
                <div class="relative z-10 flex items-center justify-between h-full">
                    <div>
                        <h1 class="text-4xl font-black tracking-tighter mb-2" :class="darkMode ? 'text-white' : 'text-slate-950'">System Active.</h1>
                        <p class="text-xs opacity-60 leading-relaxed max-w-sm">Global Administrator privileges granted. All system modules are currently <span class="text-emerald-500 font-bold italic">Synchronized</span>.</p>
                    </div>
            ...
            <a href="{{ route('manage-users') }}" class="col-span-3 row-span-2 rounded-[2.5rem] border p-8 flex flex-col justify-between transition-all duration-500 relative overflow-hidden group hover:scale-[1.05] hover:-translate-y-1 shadow-xl"
               :class="darkMode ? 'bg-slate-900/40 border-white/5 hover:border-blue-500/50' : 'bg-white/70 border-white/30 backdrop-blur-sm'">
                ...
                <div class="relative z-10">
                    <p class="text-[10px] font-black uppercase tracking-widest opacity-40 group-hover:text-blue-400 group-hover:opacity-100 transition-all">Active Users</p>
                    <p class="text-6xl font-black tabular-nums tracking-tighter mt-2 group-hover:text-blue-500 transition-colors">{{ $activeUsersCount }}</p>
                </div>
                <div class="absolute -right-2 -bottom-2 text-8xl grayscale opacity-5 group-hover:opacity-40 group-hover:grayscale-0 group-hover:-rotate-12 transition-all duration-700 select-none">🛡️</div>
                <span class="text-[9px] font-bold uppercase tracking-widest opacity-0 group-hover:opacity-100 transition-all text-blue-500">Security Audit →</span>
            </a>
            ...
            <div class="col-span-3 row-span-2 rounded-[2.5rem] border p-8 flex flex-col justify-between transition-all duration-500 relative overflow-hidden group hover:scale-[1.05] hover:-translate-y-1 shadow-xl"
                 :class="darkMode ? 'bg-slate-900/40 border-white/5 hover:border-emerald-500/50' : 'bg-white/70 border-white/30 backdrop-blur-sm'">
                ...
                <span class="text-[9px] font-bold uppercase tracking-widest opacity-0 group-hover:opacity-100 transition-all text-emerald-500">Asset Control →</span>
            </div>
            ...
            <div class="col-span-3 row-span-2 rounded-[2.5rem] border p-6 flex flex-col items-center justify-center text-center relative overflow-hidden group shadow-xl transition-all duration-500 hover:scale-[1.05]"
                 :class="darkMode ? 'bg-slate-900/40 border-white/5 hover:border-blue-500/40' : 'bg-white/60 border-white/40 backdrop-blur-md'">
            ...
            <div class="col-span-8 row-span-2 grid grid-cols-2 gap-6">
                <div class="rounded-[2.5rem] border p-8 shadow-xl relative overflow-hidden group transition-all duration-500 hover:scale-[1.02]"
                     :class="darkMode ? 'bg-slate-900/40 border-white/5' : 'bg-white/60 border-white/40 backdrop-blur-md'">
                    <h3 class="font-black uppercase tracking-widest text-[10px] mb-4 opacity-40">Active System Users</h3>
                    <div class="space-y-3 relative z-10 max-h-32 overflow-y-auto custom-scrollbar">
                        <div class="flex items-center justify-between p-2 rounded-2xl hover:bg-white/5 transition-colors">
                            <div class="flex items-center gap-3">
                                ...
                                <p class="text-[11px] font-bold">Diodana Jane Sedemo</p>
                            </div>
                            <span class="text-[8px] font-black uppercase px-2 py-1 bg-blue-500/10 text-blue-400 rounded-lg">Admin</span>
                        </div>
                        <div class="flex items-center justify-between p-2 rounded-2xl hover:bg-white/5 transition-colors">
                            <div class="flex items-center gap-3">
                                <div class="w-2 h-2 rounded-full bg-blue-500 shadow-lg shadow-blue-500/50"></div>
                                <p class="text-[11px] font-bold">Mary Jane Alfeche</p>
                            </div>
                            <span class="text-[8px] font-black uppercase px-2 py-1 bg-slate-500/10 text-slate-400 rounded-lg">Registrar</span>
                        </div>
                    </div>
                </div>
